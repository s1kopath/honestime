...
@section('page-content')
    <div class="card">
        <div class="card-header bg-info">
            <h2 class="text-center">Monthly Contest List</h5>
        </div>
        <div class="card-body">
            <div class="text-right">
                <a href="{{ route('add_monthly_contest') }}" class="btn btn-success btn-round waves-effect waves-light">
                    Add New
                </a>
            </div>
                            ...
                            <table id="order-table" class="table table-striped table-bordered nowrap dataTable"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="order-table" rowspan="1"
                                            colspan="1" aria-label="Name: activate to sort column ascending"
                                            style="width: 267.578px;">Contest Name
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="order-table" rowspan="1"
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="order-table" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
                                            style="width: 392.922px;">Reward Amount
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="order-table" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
                                ...
                                <tbody>
                                    @foreach ($month as $contest)
                                        <tr role="row" class="even">
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $contest->name }}</td>
                                            <td>{{ $contest->direct_amount }}</td>
                                            <td>{{ $contest->reward_amount }}</td>
                                            <td>
                                                <div class="btn-group">
                                                ...
                                                <div class="btn-group">
                                                    <a class="btn btn-primary"
                                                        href="{{ route('update_monthly_contest', $contest->id) }}">Edit</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
