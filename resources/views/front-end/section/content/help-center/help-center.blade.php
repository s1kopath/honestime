            ...
            <div class="uk-grid">
                <div class="uk-width-1-1 in-content-10">
                    <div class="uk-card uk-card-primary uk-card-body uk-border-rounded uk-background-bottom-left uk-background-contain"
                        style="background-image: url({{ asset('front-end/img/blockit/in-content-10-image.png') }});">
                    ...
                    <div class="uk-grid-divider uk-child-width-1-3@m uk-child-width-1-2@s uk-margin-medium-top"
                        ...
                        <div>
                            ...
                            <div class="uk-grid uk-grid-small" data-uk-grid>
                                <div class="uk-width-expand@m">
                                    ...
                                    <a href="#" class="uk-button uk-button-text">More details<i
                        ...
                        <div class="uk-visible@m">
                            <h3 class="uk-heading-bullet"><a class="uk-link-text" href="#">Security and Privacy</a>
                            </h3>
                            <div class="uk-grid uk-grid-small" data-uk-grid>
                                <div class="uk-width-expand@m">
                                ...
                                <div class="uk-grid" data-uk-grid>
                                    ...
                                    <div class="uk-width-expand@m in-margin-top-10@s">
                                        ...
                                        <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                            src="{{ asset('front-end/img/blockit/in-team-7.png') }}" width="40"
                                            height="40" alt="author-image">
                                        <p class="uk-text-small uk-margin-remove-bottom">5 articles in this
                                            collection</p>
                            ...
                            <a href="#"
                                ...
                                <div class="uk-grid" data-uk-grid>
                                    ...
                                    <div class="uk-width-expand@m in-margin-top-10@s">
                                        ...
                                        <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                            src="{{ asset('front-end/img/blockit/in-team-8.png') }}" width="40"
                                            height="40" alt="author-image">
                                        <p class="uk-text-small uk-margin-remove-bottom">2 articles in this
                                            collection</p>
                            ...
                            <a href="#"
                                ...
                                <div class="uk-grid" data-uk-grid>
                                    ...
                                    <div class="uk-width-expand@m in-margin-top-10@s">
                                        ...
                                        <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                            src="{{ asset('front-end/img/blockit/in-team-6.png') }}" width="40"
                                            height="40" alt="author-image">
                                        <p class="uk-text-small uk-margin-remove-bottom">3 articles in this
                                            collection</p>
                            ...
                            <a href="#"
                                ...
                                <div class="uk-grid" data-uk-grid>
                                    ...
                                    <div class="uk-width-expand@m in-margin-top-10@s">
                                        ...
                                        <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                            src="{{ asset('img/blockit/in-team-3.png') }}" width="40" height="40"
                                            alt="author-image">
                                        <p class="uk-text-small uk-margin-remove-bottom">8 articles in this
                                            collection</p>
