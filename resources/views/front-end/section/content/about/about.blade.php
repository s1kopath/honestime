                ...
                <div class="uk-width-1-1 uk-flex uk-flex-center">
                    <div class="uk-width-3-5@m uk-text-center">
                        <h1 class="uk-margin-remove-bottom">Putting our clients first <span class="in-highlight">since
                                1986</span></h1>
                        <p class="uk-text-lead uk-text-muted uk-margin-small-top">For more than 30 years, we’ve been
            ...
            <div class="uk-grid">
                <div class="uk-width-1-1">
                    <div class="uk-card uk-card-default uk-border-rounded uk-background-center uk-background-contain uk-background-image@m"
                        style="background-image: url({{ asset('front-end/img/blockit/in-team-background-1.png') }});"
                        ...
                        <div class="uk-card-body">
                            ...
                            <div class="uk-child-width-1-3@m uk-text-center uk-margin-small-bottom" data-uk-grid>
                                <div>
                                    <img src="{{ asset('front-end/img/blockit/in-team-1.png') }}" alt="image-team"
                                        width="200" height="200">
                                    <h4 class="uk-margin-small-top uk-margin-remove-bottom">Cynthia Dixon</h4>
                                    <span
                                        class="uk-label uk-text-small uk-border-rounded uk-margin-small-top uk-margin-small-bottom">Chief
                                ...
                                <div>
                                    <img src="{{ asset('front-end/img/blockit/in-team-4.png') }}" alt="image-team"
                                        width="200" height="200">
                                    <h4 class="uk-margin-small-top uk-margin-remove-bottom">Bryan Greene</h4>
                                    <span
                                        class="uk-label uk-text-small uk-border-rounded uk-margin-small-top uk-margin-small-bottom">Human
                                        Resources</span>
                                ...
                                <div>
                                    <img src="{{ asset('front-end/img/blockit/in-team-2.png') }}" alt="image-team"
                                        width="200" height="200">
                                    <h4 class="uk-margin-small-top uk-margin-remove-bottom">Arthur Parker</h4>
                                    <span
                                        class="uk-label uk-text-small uk-border-rounded uk-margin-small-top uk-margin-small-bottom">Executive
                                        Assistant</span>
                                    <p>Omnis voluptas assumenda omnis dolor repellendus</p>
                                    <div>
                                        <a class="uk-link-muted" href="#"><i
                        ...
                        <div class="uk-width-1-2@m">
                            <div class="uk-margin-large" data-uk-grid>
                                ...
                                <div class="uk-width-expand@m">
                                    ...
                                    <p>Reprehenderit qui in svoluptate velit esse quam molestiae vel illum qui
                                        dolorem eum fugiat quo.</p>
                                </div>
                            </div>
                            <div class="uk-margin-large" data-uk-grid>
                                <div class="uk-width-1-3@m">
