...
@section('content')
    ...
    <section class="uk-section uk-margin-small-top">
                    ...
                    <div class="in-blog-1" data-uk-grid>
                        <div class="in-stretch">
                            <article class="uk-card uk-card-default uk-border-rounded">
                                <div class="uk-card-media-top">
                                    <img src="{{ asset('front-end/img/user/image-featured-a4DfvV.jpg') }}"
                                        alt="The typical U.S. household is spending $445 more a month due to inflation">
                                </div>
                                <div class="uk-card-body">
                                    <h3>
                                        <a href="blog/the-typical-us-household-is-spending-445-more-a.html"
                                            class="link-primary text-decoration-none">The typical U.S. household is
                                            spending $445 more a month due to inflation</a>
                                    </h3>
                                    <p>Inflation is causing American households to spend $445 more per month buying
                                        the same items they did a year ago, according to an estimate from Moody’s
                                        Analytics.</p>
                                    <div class="uk-flex">
                                        <div class="uk-margin-small-right">
                                            <img class="uk-border-pill uk-background-muted"
                                                src="{{ asset('front-end/img/user/author-85z9UC.jpg') }}" alt="image-team"
                                                width="32" height="32">
                                        </div>
                        ...
                        <div class="in-stretch">
                            <article class="uk-card uk-card-default uk-border-rounded">
                                <div class="uk-card-body">
                                    <h3>
                                        <a href="javascript:void(0)" class="link-primary text-decoration-none">Biden and
                                            Harris celebrate
                                            Kwanzaa in social media posts</a>
                                    </h3>
                                    <p>The White House celebrated Kwanzaa in a pair of pre-recorded videos posted to
                                        Twitter on Monday, marking the seven-day non-denominational holiday aimed at
                                        honoring African Americans’ ancestral roots.</p>
                                    <div class="uk-flex">
                                        <div class="uk-margin-small-right">
                                            <img class="uk-border-pill uk-background-muted"
                                                src="{{ asset('front-end/img/user/author-85z9UC.jpg') }}" alt="image-team"
                                ...
                                <div class="uk-card-footer uk-clearfix">
                                    ...
                                    <div class="uk-float-right">
                                        <a href="javascript:void(0)" class="uk-button uk-button-text">Read more<i
                                                class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
                                    </div>
                                </div>
                            </article>
                        ...
                        <div class="in-stretch">
                            <article class="uk-card uk-card-default uk-border-rounded">
                                <div class="uk-card-body">
                                    <h3>
                                        <a href="javascript:void(0)" class="link-primary text-decoration-none">Amazon’s
                                            started to deliver
                                            orders by drones in California and Texas</a>
                                    </h3>
                                    <p>The retail giant already flew out some packages to customers in Northern
                                        California and a medium-sized Texan city in the run-up to Christmas.</p>
                                    <div class="uk-flex">
                                        <div class="uk-margin-small-right">
                                            <img class="uk-border-pill uk-background-muted"
                                                src="{{ asset('front-end/img/user/author-85z9UC.jpg') }}" alt="image-team"
